...
def approve_withdrawal_view(request, pk):
    ...
    if withdrawal.status == 'Pending':
        ...
        subject = f"[MarketHub] Your withdrawal of PKR {withdrawal.amount:.2f} has been approved"
        ...
        text_content = (
            ...
            f"Thank you for using MarketHub."
        )
...
def reject_withdrawal_view(request, pk):
    ...
    if withdrawal.status == 'Pending':
        ...
        subject = f"[MarketHub] Your withdrawal of PKR {withdrawal.amount:.2f} has been rejected"
        from_email = settings.DEFAULT_FROM_EMAIL
        recipient_list = [withdrawal.vendor.user.email]
        text_content = (
            f"Dear {withdrawal.vendor.business_name},\n\n"
...
def admin_approve_payment_info(request, vendor_id):
    ...
    send_mail(
        ...
        from_email='mhasseb3112@gmail.com',
